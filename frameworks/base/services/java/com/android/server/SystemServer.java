...
class ServerThread extends Thread {
	...
	LapdockObserver ldock = null;
	    ...
	    //QCOM HDMI OUT
            ...
            try {
                Slog.i(TAG, "Lapdock Observer");
                // Listen for Dock state changes
                ldock = new LapdockObserver(context);
            } catch (Throwable e) {
                reportWtf("starting LapdockObserver", e);
            }
	...
	final LapdockObserver ldockF = ldock;
        ...
        ActivityManagerService.self().systemReady(new Runnable() {
            public void run() {
                ...
                try {
                    if (ldockF != null) ldockF.systemReady();
                } catch (Throwable e) {
                    reportWtf("making Lapdock Service ready", e);
                }
                try {
